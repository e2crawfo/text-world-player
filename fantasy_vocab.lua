extra_messages = {
    "You are standing {wvery close to the the bridge's western foundation{n. If you go west you will be back on solid ground ...",
    ...
    "You don't want to stumble around in blindness anymore. You already ", "found what you need. Let's get light already!",
